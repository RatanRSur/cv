...
\name{ Ratan Rai Sur\\Blockchain Developer} % the \\[12pt] adds a blank line after name
...
\begin{resume}
    ...
    \begin{itemize} \itemsep-2pt
        ...
        \item
            Implemented mining (proof-of-work) and all consensus generating behavior, such as peer discovery and gossip.
    \end{itemize}
    ...
    \begin{itemize} \itemsep-2pt
        ...
        \item
            Linux/macOS, Bash, git, Spark, Docker, Agile, TDD
        \item Atlassian, Office, Git(Lab/Hub), Trello, Slack
    \end{itemize}
